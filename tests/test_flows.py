...
def test_not_suppressed():
    ...
    result = {'match_type': 'single', 'forward_cookie': 1,
                 'forward_match': {eth_type=0x0800,
                    ipv4_src=_ipv4_t2i(str('10.1.2.3')),
                    ipv4_dst=_ipv4_t2i(str('10.2.3.4')),
